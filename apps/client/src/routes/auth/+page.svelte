...
>
	...
	<button
		onclick={UseGoogle}
		class="bg-black hover:opacity-80 px-18 py-4 !font-sans text-[16px] cursor-pointer active:scale-97 active:opacity-75 duration-100 tracking-wide font-medium flex items-center justify-center gap-4 rounded-xl text-white"
	>
		<img src="/assets/login/g.png" class="invert-100 size-4.5" alt="Google icon" /> Continue with Google
	</button>
